...
javac -cp src -d . src/AntiFraud.java
#java AntiFraud ./paymo_input/batch_payment_50.csv ./paymo_input/stream_payment_50.csv ./paymo_output/output1.txt ./paymo_output/output2.txt ./paymo_output/output3.txt
